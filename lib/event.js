...
function Event(opts) {
	...
	function buildFinalPayload() {
		...
		var finalPayload = payloadHelper.removePropsNotInMeta(getPayload(), payloadDataPaths, meta);
		console.log('ONE', JSON.stringify(finalPayload));
		finalPayload = payloadHelper.removeUnusedDefaultedProperties(finalPayload);
		console.log('TWO', JSON.stringify(finalPayload));
